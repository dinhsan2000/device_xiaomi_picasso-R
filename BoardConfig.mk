...
KERNEL_SRC := kernel/xiaomi/sm7250
TARGET_KERNEL_CONFIG := picasso_user_defconfig
BOARD_PREBUILT_DTBOIMAGE := $(DEVICE_PATH)/prebuilt/dtbo.img-21.4.14s
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/kernel-21.4.14s
TARGET_PREBUILT_DTB := $(DEVICE_PATH)/prebuilt/dtb-21.4.14s
